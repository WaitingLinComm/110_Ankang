...
void CFOPHOTO_estimator_v4(vector<double> &CFOhat_PHOhat_d, vector<double> &v_I, vector<double> &v_Q, int Lv, vector<double> &q_I, vector<double> &q_Q, int Lq, int K, double Ts)
{   
    ...
    //while(cfo_step > 1e-7){    
        ...
        for (int i = 1; i <= L_vCFO - 11; i++) 
        //for (int i = 10; i <= L_vCFO - 11; i++) 
        {
