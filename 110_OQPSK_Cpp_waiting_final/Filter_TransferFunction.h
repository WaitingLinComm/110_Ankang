...
//////////////////////////////////////////////////////////////////
void Filter_TransferFunction(vector<double> &b, vector<double> &a, vector<double> &X_I, vector<double> &X_Q, vector<double> &Y_I, vector<double> &Y_Q)
{
    int n = a.size();
    //vector<double> z_I, z_Q; 
    //z_I.reserve(n); z_Q.reserve(n); 
    vector<double> z_I(n);  // 在HJS lab電腦跑需補0才不會錯
    vector<double> z_Q(n);
