...
void coarseTO_estimator_v2(vector<double> &r_I,  vector<double> &r_Q, int L_r, vector<double> &q_I, vector<double> &q_Q, int L_q, int sps, vector<double> &y1_I, vector<double> &y1_Q,  vector<int> &m)
{  
    clock_t t1, t2;
    // realize : q(end : -1 : 1)
