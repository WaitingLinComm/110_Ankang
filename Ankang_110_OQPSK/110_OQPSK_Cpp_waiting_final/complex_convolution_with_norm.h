/////////////////////////////////////////////////////////
// complex_convolution_with_norm
// 
// The code merges complex_convolution.h with y1_norm2.h to speed up.
// 
...
/////////////////////////////////////////////////////////
void complex_convolution_with_norm(vector<double> &y1_norm2, int Lz,  vector<double> &x_I, vector<double> &x_Q, int Lx, vector<double> &y_I, vector<double> &y_Q, int Ly)
{    
    clock_t t1, t2;
    ...
    for (int i = 0; i < Lz; i++) {
        ...
        y1_I = z_ifft_conv[i][0] * 1./N;
        y1_Q = z_ifft_conv[i][1] * 1./N;
        y1_norm2.push_back(pow(y1_I,2) + pow(y1_Q,2));
    }
    //t2 = clock();
