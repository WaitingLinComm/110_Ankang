function [cfo_hat, pho_hat, d, y2_norm2_buffer, vCFO_buffer] = CFOPHOTO_estimator_v3(v, q, K, Ts)
% CFOPHOTO_estimator_v3.m
% CFOPHOTO_estimator_v3.m is the speed up version of CFOPHOTO_estimator.m
% : only do one while loop.
% 
...
%while(cfo_step > 1e-7)
    ...
    for i =10 : length(vCFO)-11 % or equal to using i = 10 
