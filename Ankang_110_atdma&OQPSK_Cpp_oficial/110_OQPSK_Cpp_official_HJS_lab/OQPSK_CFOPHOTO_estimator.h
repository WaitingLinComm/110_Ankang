...
void OQPSK_CFOPHOTO_estimator(vector<double> &CFOhat_PHOhat_d, vector<double> &v_I, vector<double> &v_Q, int Lv, vector<double> &q_I, vector<double> &q_Q, int Lq, int K, double Ts)
{   
    //////////////// Parameter setting /////////////////
    int cfo_estimate = 0;
