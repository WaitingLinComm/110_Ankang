...
void OQPSK_CFOPHOcompen(vector<double> &OutSig_I, vector<double> &OutSig_Q, vector<double> &InSig_I, vector<double> &InSig_Q, int DataLength, double pho, double cfo, double Ts)
{    
