...
void OQPSK_DownConversion(vector<double> &OutData_I, vector<double> &OutData_Q, vector<double> &InData_I, vector<double> &InData_Q, int DataLength, double fc, double fs)
{
