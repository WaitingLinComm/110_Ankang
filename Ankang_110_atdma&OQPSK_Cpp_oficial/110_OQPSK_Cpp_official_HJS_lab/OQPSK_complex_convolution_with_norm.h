...
void OQPSK_complex_convolution_with_norm(vector<double> &y1_norm2, int Lz,  vector<double> &x_I, vector<double> &x_Q, int Lx, vector<double> &y_I, vector<double> &y_Q, int Ly)
{    
    clock_t t1, t2;
