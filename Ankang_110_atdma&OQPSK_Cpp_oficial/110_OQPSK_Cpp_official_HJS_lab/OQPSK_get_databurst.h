void OQPSK_get_databurst(vector<double> &RegetReceived_pilot_I, vector<double> &RegetReceived_pilot_Q, vector<double> &Regetdata_burst_I, vector<double> &Regetdata_burst_Q, vector<double> &burst_interval, vector<double> &Sig_I, vector<double> &Sig_Q, vector<double> &syncSig_I,vector<double> &syncSig_Q, int exact_pilot_position, double new_sps)
{
