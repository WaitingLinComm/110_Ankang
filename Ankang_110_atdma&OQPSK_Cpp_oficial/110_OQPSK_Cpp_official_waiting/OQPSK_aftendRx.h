...
{  
    ...
    OQPSK_conv_vec(SigCFOCPOTOcompen_I, Pulseshaping_flip_I, u_hat_I, L_SigCFOCPOTOcompen, L_pulseshaping, L_u_hat);
    OQPSK_conv_vec(SigCFOCPOTOcompen_Q, Pulseshaping_flip_I, u_hat_Q, L_SigCFOCPOTOcompen, L_pulseshaping, L_u_hat);
    ...
    cout << u_hat_I.size() << '\n';
    cout << l_hat_I.size() << '\n';
    cout << L_l_hat_truncate << '\n';
    cout << l_hat_truncate_I.size() << '\n';
    cout << b_q_hat.size() << '\n';
    cout << RxSym.size() << '\n';
    cout << max << '\n';

    test_printf_2_vec(RxSym_normalized, b_q_hat, 20);
    */
}        