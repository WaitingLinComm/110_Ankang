...
*/
//vector<double> OQPSK_main(int pilotType, vector<int> &pilot_manual, double fc, double fsy, double fs, const char *filename, int filelength)
vector<double> OQPSK_main_3(int pilotType, vector<int> &pilot_manual, double fc, double fsy, double fs, const char *filename, int filelength, vector<int> &demd_symbol_per_burst, vector<int> &coarse_pilot_position, vector<int> &end_burst_position)
//int main() 
{ 
    ...
    t12 = clock();       
    // printf("Course TO estimation is done in %1f(sec).\n", (t12-t11)/(double)(CLOCKS_PER_SEC));
    // for(int i = 0; i < coarse_pilot_position.size(); i++){
    //     printf("%d ", coarse_pilot_position[i]);
    //     printf("%d ", end_burst_position[i]);
    // }
    ...
    for (int i = 0; i < number_of_bursts; i++){
        ...
        int end_burst_original = end_burst_position[i];
        ...
        //cout << end_burst_original - start_burst << endl;
...
// MODE1    
    ...
    //     }    
    // }
    // b_i_hat_d_buffer.clear(); b_q_hat_d_buffer.clear();
// MODE5
    int count_symbol;
    for(int i = 1; i <= number_of_bursts; i++){
        if(i == 1){
