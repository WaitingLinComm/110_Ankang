...
void pilot_detection_8PSK( vector<double> resample_signal_I , vector<double>  resample_signal_Q , int IPOINT , char &pilot , double &power ){

double power_temp = 0 ;
for ( int char_ind = 73 ; char_ind < 73+8 ; char_ind++ ){
